...
try {
    ...
    $tes = $myPDO->query("SELECT suara, jumlah FROM tahap1.vw_hasil_dpm WHERE fakultas = 'FISIB';");
    $tes2 = $myPDO->query("SELECT persentase_dari_suara_sah_dalam_dapil FROM tahap1.vw_hasil_dpm WHERE fakultas = 'FISIB';");
    $persentase=array();
    $jumlah=array();
    $keterangan=array();
...
<body class="bg-light">
    <div style="margin-left: auto; margin-right: auto;">
        ...
        <h4 style="text-align: center;">Pemilihan DPM-KM Dapil Fakultas Ilmu Sosial dan Ilmu Budaya Universitas Trunojoyo Madura tahun 2020-2021</h4>
    </div>
    ...
    // Create the chart
        Highcharts.chart('container', {
            ...
            series: [
                {
                    name: "Hasil Perhitungan Pemilu DPM-KM Dapil Ilmu Sosial dan Ilmu Budaya",
                    colorByPoint: true,
                    data: [
                        {
